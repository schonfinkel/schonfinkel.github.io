...
#+ATTR_HTML: :src ../static/img/some_experiments_with_erlang_and_nix/00_lyceum_client.png :width 50% :height 50% :align center
...
#+NAME:   fig:lyceum-client
#+ATTR_HTML: :src ../static/img/some_experiments_with_erlang_and_nix/01_postgres.png :width 50% :height 50% :align center

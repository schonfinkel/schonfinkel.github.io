...
+ Cloud Providers: Many modern services (like AWS Route 53 or Cloudflare) ignore
  zone transfers entirely, opting for faster, proprietary database replication methods.

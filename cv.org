...
** Software Engineer (Contractor) :cventry:
:PROPERTIES:
:CV_ENV:   cventry
:FROM:     <2026-01-01 Thu>
:EMPLOYER: TradeKart
...
- F# backend development and DevOps.

** OCaml Developer (Contractor) :cventry:
:PROPERTIES:
:CV_ENV:   cventry
:FROM:     <2025-04-21 Tue>
:TO:       <2025-12-22 Mon>
...
+ Core Contributor in [[https://github.com/dont-rely-on-nulls/sakura][Sakura]], an extended relational engine that targets [[https://www.erlang.org/doc/apps/mnesia/mnesia.html][MNESIA]].
...
+ I have a talk about [[https://www.youtube.com/watch?v=RJWmmI9Vwgw][Erlang and NixOS]] on Gambiconf 2025.

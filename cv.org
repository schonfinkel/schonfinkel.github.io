...
promised, which simple abstractions and the least amount of overhead.
...
+ Core developer of [[https://github.com/dont-rely-on-nulls/domino][Domino]], an extended relational engine written in Erlang that
  targets MNESIA.
